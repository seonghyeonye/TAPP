...
def main():
    ...
    data_collator = DataCollatorForNI(
        ...
        decoder_only = True,
        icil=data_args.icil,
        demo_path=data_args.demo_path,
        adaptive=data_args.adaptive,
    )
    ...
    def compute_ni_metrics(dataset, preds, save_prefix=None):
        ...
        if save_prefix is not None:
            with open(os.path.join(training_args.output_dir, f"{save_prefix}_eval_predictions.jsonl"), "a") as fout:
    ...
    print("before initializinig the trainer")
    # Initialize our Trainer

    # This is to prevent loading the model to GPU twice
    print("generation length",training_args.generation_max_length, data_args.max_source_length )
    training_args.generation_max_length = training_args.generation_max_length + data_args.max_source_length
    ...
    if training_args.do_predict:
        ...
        print("predictions",predict_results.predictions)
