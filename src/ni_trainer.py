...
# this is a decoder-only evaluation code for decoder-only models. For encoder-decoder architecture LMs, refer to the original repo of https://github.com/yizhongw/Tk-Instruct/blob/main/src/ni_trainer.py. 
class NITrainer(Trainer):
    ...
    def evaluation_loop(
        ...
        self._max_length = args.generation_max_length
        self._num_beams = 1
    ...
    def greedy_generate(self,input_ids: torch.Tensor, max_seq_len: int,
                        verbose=True):
        ...
        for _ in trange:
            ...
            model_out = outputs.logits
            layer_past = outputs.past_key_values
            print("output shape", model_out.shape, len(layer_past), len(layer_past[0]), layer_past[0][0].shape)
            # print("layer", layer_past)
    ...
    def prediction_step(
        ...
        print("@@@",generation_inputs, generation_inputs.shape)
